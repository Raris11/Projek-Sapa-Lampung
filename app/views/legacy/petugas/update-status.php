            ...
            <div class="card mb-24">
                <div class="card-header">
                    <div>
                        ...
                        <div class="card-subtitle"><?= htmlspecialchars($data['kode_tiket'] ?: $data['id_laporan']); ?></div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-select-status" required>
                                <option value="Ditugaskan" <?= ($data['status'] == 'Ditugaskan') ? 'selected' : ''; ?>>Ditugaskan (Tugas Diterima)</option>
                                <option value="Diproses" <?= ($data['status'] == 'Diproses') ? 'selected' : ''; ?>>Diproses (Sedang Ditindaklanjuti)</option>
